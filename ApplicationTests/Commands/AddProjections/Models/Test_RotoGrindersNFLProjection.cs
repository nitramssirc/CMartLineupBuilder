...
{
    [TestClass]
    public class Test_RotoGrindersNFLUploadedProjection
    {
        #region Tests
        ...
        private RotoGrindersNFLUploadedProjection CreateRotoGrindersNBAProjection(
            int player_id = 1,
            string team = "ATL",
            string opp = "BOS",
            string pos = "PG",
            ...
            int partner_id = 2001)
        {
            return new RotoGrindersNFLUploadedProjection(
                player_id,
                team,
                opp,
                pos,
